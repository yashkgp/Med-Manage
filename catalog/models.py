...
class Doctor(models.Model):
    ...
    def patients_treated(self):
        ...
        return (len(Prescription.objects.filter(doctor_visited__first_name__contains=self.first_name,doctor_visited__last_name__contains=self.last_name)))
class Medicine(models.Model):

    name = models.ForeignKey(Med_data,on_delete=models.SET_NULL,null=True)
...
class Prescription(models.Model):
    ...
    doctor_visited = models.ForeignKey(Doctor,on_delete=models.SET_NULL,null=True)
...
class Patient(models.Model):
    ...
    visits = models.ManyToManyField(Prescription)
